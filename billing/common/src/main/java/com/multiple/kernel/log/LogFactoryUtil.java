...
package com.multiple.kernel.log;

import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;
import java.util.concurrent.ConcurrentMap;

import com.multiple.common.log.Log4jLogFactoryImpl;
...
public class LogFactoryUtil {
	...
	private static volatile LogFactory _logFactory = new Log4jLogFactoryImpl();
